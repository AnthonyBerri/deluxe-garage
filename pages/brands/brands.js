                    ...
                    if (brand) {
                        main.innerHTML = `
                            <div class="card">
                                ...
                                <cards-brands></cards-brands>  
                            </div>
                        `;

                        const cardsContainer = document.querySelector('cards-brands');
                        if (cardsContainer && brand.cars) {
                            cardsContainer.setAttribute('data-cars', JSON.stringify(brand.cars));
                        }
                    } else {
